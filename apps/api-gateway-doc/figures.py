...
STRINGS = {
    ...
    "he": {
        ...
        "c2b.steps": ["1. אימות זהות", "2. access token קצר מועד", "3. בקשת API עם ה-access token",
                      "4. אימות ה-token והטענות (claims); אכיפת הרשאות ומדיניות",
        ...
        "gitops.secrets": "ניהול סודות",
        "gitops.supplied": "הסודות מסופקים\nבזמן הפריסה",
        "gitops.note": "Git מתעד מה התבקש ואושר; יומן הביקורת של ה-Gateway מתעד מה בוצע.",
        "dist.mgmt": "Management Plane\n(ניהול מרכזי)",
        ...
        "op.caps.body": "אימות זהות · הרשאה · ניתוב · בדיקות תקינות · זמני קצוב · הגבלת קצב · "
                        "המרה · מטמון · אימות סכמה · רישום יומנים · ביקורת",
        "op.dataplane": "Data Plane מבוזר",
        "op.site": "{site}\nAPI Gateway",
        "op.backend": "שירותי Backend של {site}",
        "op.sites": ["אתר A", "אתר B"],
        "op.org.title": "הארגון",
        "op.org.body": "ממשל ותקנים",
        "op.guardrails": "תקנים הממומשים כמעקות בטיחות",
